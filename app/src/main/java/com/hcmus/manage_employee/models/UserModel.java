...
public class UserModel {
    ...
    public UserModel(String name, String role, String profile_img, String emp_id, String mail, String mobile, String sex, String birthdate, String password,  List<String> allowance_ids) {
        this.name = name;
        this.role = role;
